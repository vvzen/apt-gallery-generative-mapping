...
void ofApp::setup(){
	...
	clockGridSource = new ClockGridSource();
    clockGridSource->setup();
    piMapper.registerFboSource(clockGridSource);
    
    solarSystemSource = new SolarSystemSource();
    solarSystemSource->setup();
    piMapper.registerFboSource(solarSystemSource);
    
    hypnotizeSource = new HypnotizeSource();
    hypnotizeSource->setup();
    piMapper.registerFboSource(hypnotizeSource);
